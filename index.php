                ...
                <div class="col-lg-6">
                    <div class="banner__item">
                        ...
                        <div class="banner__content">
                            ...
                            <a class="btn-one wow fadeInUp mt-65" data-wow-delay=".3s" href="shop.php"><span>Shop
                                    Now</span></a>
                        </div>
                    </div>
                </div>
                ...
                while ($row = mysqli_fetch_assoc($latest)): ?>
                  <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="product__item bor">
                      ...
                      <a href="#" class="product__cart d-block bor-top add-to-cart" data-id="<?php echo $row['id']; ?>">
                ...
                while ($row = mysqli_fetch_assoc($topRated)): ?>
                  <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="product__item bor">
                      ...
                      <a href="#" class="product__cart d-block bor-top add-to-cart" data-id="<?php echo $row['id']; ?>">
                        <i class="fa-regular fa-cart-shopping primary-color me-1"></i><span>Add to cart</span>
                      </a>
                    </div>
                  </div>
              <?php endwhile; else: ?>
